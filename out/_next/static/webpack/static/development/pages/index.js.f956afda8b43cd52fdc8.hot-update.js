...
function (_React$Component) {
  ...
  function _default(props) {
    ...
    var loading = props.children && props.children.length > 0;
    _this.state = {
      isLoading: loading
    };
    return _this;
  ...
  _createClass(_default, [{
    ...
    value: function componentWillReceiveProps(nextProps) {// console.log('Receive new props',nextProps);
      // const loading = nextProps.children && nextProps.children.length > 0;
...
//# sourceMappingURL=index.js.f956afda8b43cd52fdc8.hot-update.js.map