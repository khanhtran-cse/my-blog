...
function (_React$Component) {
  ...
  function _default(props) {
    ...
    var loading = props.children && props.children != [];
    _this.state = {
      isLoading: loading
    };
    return _this;
  ...
  _createClass(_default, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      var loading = nextProps.children && nextProps.children != [];
      this.setState({
        isLoading: loading
      });
    }
...
//# sourceMappingURL=index.js.583d6f7f6f2bf203e0b0.hot-update.js.map