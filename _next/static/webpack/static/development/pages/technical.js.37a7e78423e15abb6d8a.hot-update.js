...
function (_React$Component) {
  ...
  function _default(props) {
    ...
    console.log(props);
    var hasData = props.children && (props.children != {} || props.children.length > 0);
    _this.state = {
      isLoading: !hasData
    };
    return _this;
  ...
  _createClass(_default, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      var hasData = nextProps.children && nextProps.children != {} && nextProps.children != [];
      this.setState({
        isLoading: !hasData
      });
    }
...
//# sourceMappingURL=technical.js.37a7e78423e15abb6d8a.hot-update.js.map