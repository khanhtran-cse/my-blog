...
function (_React$Component) {
  ...
  function _default(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(_default).call(this, props)); // console.log('New container');

    var hasData = props.children && props.children.length > 0;
    _this.state = {
      isLoading: !hasData
    };
    return _this;
  ...
  _createClass(_default, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      var hasData = nextProps.children && nextProps.children.length > 0;
      this.setState({
        isLoading: !hasData
      });
    }
...
//# sourceMappingURL=index.js.5d5bed27c527a9613cd8.hot-update.js.map