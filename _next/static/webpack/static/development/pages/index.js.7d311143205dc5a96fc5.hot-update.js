...
function (_React$Component) {
  ...
  function _default(props) {
    ...
    var loading = props.children && nextProps.children.length > 0;
    _this.state = {
      isLoading: loading
    };
    return _this;
  ...
  _createClass(_default, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      var loading = nextProps.children && nextProps.children.length > 0;
      this.setState({
        isLoading: loading
      });
    }
...
//# sourceMappingURL=index.js.7d311143205dc5a96fc5.hot-update.js.map